...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/index/b.css">
		...
		<header>
			<div id="cabeçalho_menu">
				<div class="menu" id="menuMobile">
					...
					<a href="?go=sair" id="login" class="menu_op">
						<p>SAIR</p>
					</a>
				</div>
				<!-- LOGO DA FEIRA -->
				...
				<div class="redes_sociais_escola">
					<div id="instagram_redes-div">
						...
						<div class="informação_insta">
							...
							<a href="https://www.instagram.com/feiradoempreendedor_/" id="seguir_but" target="_blank"><button class="link_button">Seguir</button></a>
						</div>
					</div>
					<div id="facebook_redes-div">
						<a href="https://www.facebook.com/jornalistajoseitamardarochacandido/" target="_blank"><img src="img/redes/facebook_redes.png" id="facebook_redes" class="redes_escola"></a>
